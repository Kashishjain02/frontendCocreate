...
export const MeetingTime = (props) => {
    ...
    const [events, setEvent] = useState([{
        ...
        end: "2023-04-07T08:00:36.790Z",
        id: "5e88830672d089c53c46ece3",
        start: "2023-04-07T05:00:36.790Z",
        title: "Lunch"
    },
    {
        allDay: false,
        ...
        end: "2023-04-04T10:00:00",
        id: "5e888302e62149e4b49aa609",
        start: "2023-04-04T13:35:36",
        textColor: "#212121",
        title: "Meeting"
    }]);
 ...
 const recurringEvents = [{
    startTime: '13:00',
    endTime: '14:30',
    daysOfWeek: [1], // 1 for Monday, 2 for Tuesday, etc.
    startRecur: moment().startOf('week').toDate(), // start of current week
    endRecur: moment().add(1, 'year').toDate(), // end of next year
  }];
